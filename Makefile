...
CFLAGS += -g -Wall -Wextra -std=c99 -MMD -march=rv32imf_zicsr_zifencei -mabi=ilp32f $(addprefix -I, $(INC_DIRS))
LDFLAGS += -T$(LINKER_SCRIPT) -Wl,--no-warn-rwx-segments -march=rv32imf_zicsr_zifencei  -mabi=ilp32f  -nostdlib -nostartfiles --specs=nano.specs
